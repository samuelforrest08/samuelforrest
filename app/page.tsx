const socialLinks = [
  {
    ...
    description: "I post frequently on X",
    icon: (
  ...
  },
  {
    ...
    description: "View my latest YouTube videos",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width={14} height={14}>
  ...
  },
  {
    ...
    description: "Give me some kudos on Strava",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width={14} height={14}>
  ...
  return (
    <div className="pb-20">
      ...
      <ul className="space-y-2 text-sm text-neutral-300">
        {socialLinks.map(({ label, href, description }) => (
          <li key={label}>
            {description} —{" "}
            <a
              href={href}
