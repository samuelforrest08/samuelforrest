    ...
    <div className="flex items-center gap-1">
      {links.map(({ label, href, icon }) => (
        <a
          ...
          aria-label={label}
          className="group p-1.5 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
        >
          {icon}
        </a>
      ))}
